    ...
    for (size_t i = 0; i < contours.size(); i++)
    {
        ...
        if (contourArea(cnt) > 50)
        {
            ...
            if (rec.height > 28)
            {
                ...
                imshow("all", image);
                if(result == 10 or result == 11 or result == 11 or result == 13){
                    count_number++;
                    middle_digit = result;
                    count_check = 0;
                }
                if((result == 0 or result == 1 or result == 2 or result == 3 or result == 4 or result == 5 or result == 6 or result == 7 or result == 8 or result == 9) and count_number == 0){
                    first_number = first_number + (result * 10 * count_check);
                    count_check++;
                }
                else if((result == 0 or result == 1 or result == 2 or result == 3 or result == 4 or result == 5 or result == 6 or result == 7 or result == 8 or result == 9) and count_number == 1){
                    second_number = second_number + (result * 10 * count_check);
                    count_check++;
                }
